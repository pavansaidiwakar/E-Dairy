...
<div>
	...
	%>
	   <tr>
			...
			<td align="center"><input  type="number"   name="quantity" style="width:50px; border:0px; " placeholder="1" min="1"/></td>
			<td align="center"><%= rs.getString("price") %></td>
	...
	<% }%>
	 ...
	 <a href=<%= url %>><button style="width:100px;margin-top:100px;margin-left:120px;">Empty cart</button></a>
	...
	<button style="float:right;" onclick="call(<%=cartitems.length%>)">Checkout</button></a>
