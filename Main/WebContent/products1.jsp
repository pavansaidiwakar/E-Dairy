...
<div class="well well-small">
	<ul class="nav nav-list">
		...
		<li><a href="products.html"><span class="icon-chevron-right"></span>Fermented Products</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Sweets</a></li>
