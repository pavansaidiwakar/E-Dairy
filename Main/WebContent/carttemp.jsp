...
-->
	...
	%>
	   <tr>
			...
			<% session.setAttribute(rs.getString("pid"),rs.getString("variants"));%></td>
			<td align="center"><%= rs.getString("variants") %>ml</td>
			<td align="center"><%= rs.getString("price") %></td>
			<td align="center"><input  type="number"  style="width:50px; border:0px; " value="1" min="1"/></td>
			<td align="center"><%= rs.getString("price") %></td>
	...
	<button style="float:right;" class="defaultBtn" onclick="call(<%=cartitems.length%>)"><h4>Checkout</h4></button></a>
